# CLAUDE.md — game/enemies (Phases 9E + 10F + 10G + ER-4 + NE-3)
...
**dormant** — see its section below. The seventh, `Drummer`, is LIVE since NE-3
(`ENABLE_DRUMMER = True`, from round 25) and brings the game's FIRST buff/aura
mechanism with it — read its section before adding any status effect. When you
