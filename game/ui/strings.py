...
_STRINGS = {
    ...
    "boss_cutscene.subtitle": "Choose an upgrade",
    "boss_cutscene.subtitle_reward": "+{love} love — choose an upgrade",
    ...
    "building.upgrade.survived_last_round": "SURVIVED LAST ROUND",
    ...
    "hud.boss_next_off": "No boss this round",
    "hud.boss_next_on": "Boss round incoming!",
