...
_BASELINE = {
    "main_menu": [
        ...
        HudRect(rect=(405, 180, 26, 26), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(405, 180, 26, 26), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='SET', pos=(418, 185), font_key='lg', color=(235, 225, 195), align='center'),
    ],
    "pause": [
    ...
    "levelup": [
        ...
        HudText(text='CHOOSE YOUR REWARD', pos=(320, 87), font_key='xxl', color=(255, 200, 50), align='center'),
        HudRect(rect=(218, 125, 100, 110), color=(42, 34, 68), border_radius=0, width=0),
        HudRect(rect=(218, 125, 100, 110), color=(80, 65, 120), border_radius=0, width=1),
        HudText(text='Card A', pos=(268, 130), font_key='md', color=(235, 225, 195), align='center'),
        HudText(text='Cost  5', pos=(268, 184), font_key='sm', color=(255, 200, 50), align='center'),
        HudText(text='does a thing', pos=(268, 197), font_key='sm', color=(150, 140, 120), align='center'),
        HudRect(rect=(322, 125, 100, 110), color=(42, 34, 68), border_radius=0, width=0),
        HudRect(rect=(322, 125, 100, 110), color=(80, 65, 120), border_radius=0, width=1),
        HudText(text='Old Name', pos=(372, 130), font_key='sm', color=(150, 140, 120), align='center'),
        HudLines(points=((370, 146), (372, 143), (374, 146)), color=(80, 210, 80), width=2, closed=False),
        HudText(text='Card B', pos=(372, 148), font_key='md', color=(235, 225, 195), align='center'),
        HudText(text='tiered thing', pos=(372, 215), font_key='sm', color=(150, 140, 120), align='center'),
        HudText(text='Tier 2 of 3', pos=(372, 221), font_key='sm', color=(150, 140, 120), align='center'),
    ],
    "hud": [
        ...
        HudRect(rect=(6, 23, 95, 34), color=(40, 32, 58), border_radius=4, width=0),
        HudRect(rect=(6, 23, 95, 34), color=(150, 135, 185), border_radius=4, width=1),
        HudText(text='+5/round', pos=(8, 25), font_key='sm', color=(214, 96, 136), align='left'),
        HudSprite(slot_key='ui_icon_lives', dest=(8, 33), size=(9, 9), tint=None, flip=False, animation='idle', anim_time_ms=0),
        HudText(text='LIVES 3', pos=(19, 33), font_key='md', color=(200, 55, 55), align='left'),
        HudText(text='0/4 tiles', pos=(8, 42), font_key='md', color=(150, 140, 120), align='left'),
        ...
        HudRect(rect=(6, 55, 28, 14), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(6, 55, 28, 14), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='1×', pos=(20, 56), font_key='sm', color=(255, 200, 50), align='center'),
        HudRect(rect=(6, 55, 28, 14), color=(255, 200, 50), border_radius=3, width=2),
        HudRect(rect=(37, 55, 28, 14), color=(50, 45, 70), border_radius=3, width=0),
        HudRect(rect=(37, 55, 28, 14), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='1.5×', pos=(51, 56), font_key='sm', color=(150, 140, 120), align='center'),
        HudRect(rect=(68, 55, 28, 14), color=(50, 45, 70), border_radius=3, width=0),
        HudRect(rect=(68, 55, 28, 14), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='2×', pos=(82, 56), font_key='sm', color=(150, 140, 120), align='center'),
        HudRect(rect=(6, 72, 45, 14), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(6, 72, 45, 14), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='DRAG SEL', pos=(28, 73), font_key='sm', color=(235, 225, 195), align='center'),
    ],
    "building_panel": [
    ],
    "cheat_menu": [
        HudRect(rect=(0, 0, 640, 360), color=(0, 0, 0, 150), border_radius=0, width=0),
        HudRect(rect=(265, 108, 110, 144), color=(42, 34, 68), border_radius=0, width=0),
        HudRect(rect=(265, 108, 110, 144), color=(80, 65, 120), border_radius=0, width=1),
        HudText(text='CHEATS', pos=(320, 112), font_key='lg', color=(255, 200, 50), align='center'),
        HudRect(rect=(362, 111, 10, 9), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(362, 111, 10, 9), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='X', pos=(367, 109), font_key='md', color=(235, 225, 195), align='center'),
        HudRect(rect=(270, 124, 100, 13), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(270, 124, 100, 13), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='+10 Love', pos=(320, 124), font_key='md', color=(235, 225, 195), align='center'),
        HudRect(rect=(270, 139, 100, 13), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(270, 139, 100, 13), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='Skip Round', pos=(320, 139), font_key='md', color=(235, 225, 195), align='center'),
        HudRect(rect=(270, 154, 100, 13), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(270, 154, 100, 13), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='LEVEL UP', pos=(320, 154), font_key='md', color=(235, 225, 195), align='center'),
        HudRect(rect=(270, 169, 100, 13), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(270, 169, 100, 13), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='Infinite Money', pos=(320, 169), font_key='md', color=(235, 225, 195), align='center'),
        HudRect(rect=(270, 184, 100, 13), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(270, 184, 100, 13), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='Unlock All Tech', pos=(320, 184), font_key='md', color=(235, 225, 195), align='center'),
        HudRect(rect=(270, 199, 100, 13), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(270, 199, 100, 13), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='Debug Log', pos=(320, 199), font_key='md', color=(235, 225, 195), align='center'),
        HudRect(rect=(270, 216, 100, 1), color=(80, 65, 120), border_radius=0, width=0),
        HudText(text='Jump to round:', pos=(270, 218), font_key='sm', color=(150, 140, 120), align='left'),
        HudRect(rect=(270, 227, 48, 11), color=(40, 32, 58), border_radius=0, width=0),
        HudRect(rect=(270, 227, 48, 11), color=(80, 65, 120), border_radius=0, width=1),
        HudText(text='round', pos=(273, 229), font_key='sm', color=(150, 140, 120), align='left'),
        HudRect(rect=(321, 227, 49, 11), color=(75, 60, 115), border_radius=3, width=0),
        HudRect(rect=(321, 227, 49, 11), color=(80, 65, 120), border_radius=3, width=1),
        HudText(text='Go to Round', pos=(345, 227), font_key='sm', color=(235, 225, 195), align='center'),
    ],
    "game_log": [
